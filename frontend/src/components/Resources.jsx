...
function Resources() {
  const resources = [
    ...
    { title: 'Healthcare', description: 'Every CUNY campus has a Health Center that can provide a variety of services.', link: 'https://www.healthycuny.org/cuny-health-centers' },
